...
dir_tagcounts=/project/mstephens/ATAC_DNase/ATAC-seq_GGR_Duke/results/ATAC-seq_tagcounts/
dir_count_matrix=/project/mstephens/ATAC_DNase/ATAC-seq_GGR_Duke/results/ATAC-seq_count_matrix/${pwm_name}/
